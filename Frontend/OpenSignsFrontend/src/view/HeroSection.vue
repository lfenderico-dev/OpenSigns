<template>
  <div class="h-[100vh] bg-[url('@/assets/photo/backgroundHero.jpg')] bg-cover bg-center flex flex-col pt-30">
    ...
    <router-link class="m-8 p-4 bg-green-700 text-white font-bold rounded-xl shadow-lg shadow-green-900 text-center transition active:scale-120 active:translate-y-4 hover:-translate-y-2" to="/dashboard">
